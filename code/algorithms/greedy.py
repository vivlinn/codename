...
class Greedy():
    ...
    def track_shared(self, y, x, axis, direction):
        if axis == "x":
            if direction == 1:
                matrix = self.grid.matrix_right
            else:
                matrix = self.grid.matrix_left
        else:
            if direction == 1:
                matrix = self.grid.matrix_up
            else:
                matrix = self.grid.matrix_down
